...
C --- Apply Variable Emission Rate Factor, Based on Value of BFLAG
...
CRWB     penetrated plumes.
         ...
         IF (URBSTAB .AND. L_MorningTrans(IURB)) THEN
            OBUOUT = URBOBULEN(IURB)
         ELSE IF (URBSTAB) THEN
