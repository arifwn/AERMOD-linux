...
CRWB        R. Brode, PES, 8/15/96
            ...
            SVEFFD = MAX( SVEFFD, SVMIN, 0.05D0*UEFFD )
...
CRWB        R. Brode, PES, 8/15/96
            ...
            SVEFF3 = MAX( SVEFF3, SVMIN, 0.05D0*UEFF3 )
...
CRWB        Computation of CENTER (plume centroid height) has been
CRWB        moved to SUB. CENTROID (CALC1.FOR).
