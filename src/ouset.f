...
C     Write Header to File.  Skip Header if FATAL.
 ...
 9005    FORMAT('* AERMOD (',A6,'): ',A68,5X,A8)
         WRITE(IMXUNT(INDGRP,INDAVE),9007) RUNTIM, (MODOPS(I),I=1,20)
...
C     Write Header to File for Formatted Plot Files.  Skip Header if FATAL.
     ...
     &                                     RUNDAT
 9005    FORMAT('* AERMOD (',A6,'): ',A68,5X,A8)
         WRITE(IPSUNT(INDGRP,INDAVE),9007) RUNTIM, (MODOPS(I),I=1,20)
 9007    FORMAT('* MODELING OPTIONS USED:',T93,A8,/'* ',20(A9,1X))
...
C     Write Header to File.  Skip Header if FATAL.
 ...
 9005    FORMAT('* AERMOD (',A6,'): ',A68,5X,A8)
         WRITE(IMDUNT(INDGRP),9007) RUNTIM, (MODOPS(I),I=1,20)
 9007    FORMAT('* MODELING OPTIONS USED:',T93,A8,/'* ',20(A9,1X))
...
C     Write Header to File.  Skip Header if FATAL.
 ...
 9005    FORMAT('* AERMOD (',A6,'): ',A68,5X,A8)
         WRITE(IMDUNT_BYYR(INDGRP),9007) RUNTIM, (MODOPS(I),I=1,20)
 9007    FORMAT('* MODELING OPTIONS USED:',T93,A8,/'* ',20(A9,1X))
