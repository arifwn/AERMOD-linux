...
C              Write Header Information
               ...
               WRITE(IAPUNT(IGRP),9007) RUNTIM, (MODOPS(I),I=1,20)
...
C     WRITE Error Message for Problem Writing to Postprocessor File
 ...
 9007 FORMAT('* MODELING OPTIONS USED:',T93,A8,/'* ',20(A9,1X))
...
C           Write Header Information
            ...
            WRITE(IPPUNT(IGRP),9007) RUNTIM, (MODOPS(I),I=1,20)
...
C                 Write Header Information
     ...
     &                                               TITLE1(1:68),RUNDAT
                  WRITE(IPLUNT(IVAL,IGRP,IAVE),9007) RUNTIM, 
     &                                               (MODOPS(I),I=1,20)
                  IF (PM25AVE .OR. NO2AVE .OR. SO2AVE) THEN
...
C     WRITE Error Message for Error Reading Threshold File
 ...
 1000 RETURN
      ...
      SUBROUTINE PRTPM25
C***********************************************************************
C                 PRTPM25 Module of ISC3 Short Term Model - ISCST3
C
...
C***********************************************************************
C                 PRTPM25SUM Module of ISC3 Short Term Model - ISCST3
C
...
C              Write Header Information
               ...
               WRITE(ISHUNT(IGRP),9007) RUNTIM, (MODOPS(I),I=1,20)
...
C              Write Header to File
               ...
               WRITE(IRKUNT(IAVE),9007) RUNTIM, (MODOPS(I),I=1,20)
...
C        Write Header Information
         WRITE(IMXDCUNT(IGRP1),9005) VERSN,
     &                                   TITLE1(1:68),RUNDAT
         WRITE(IMXDCUNT(IGRP1),9007)RUNTIM,(MODOPS(I),
     &                                               I=1,20)
C
         IF (PM25AVE) THEN
