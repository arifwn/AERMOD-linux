...
C           Print Out The Source Contributions for the Last Page
     ...
     &                                            J=1+NSPP*(N-1),INGRP)
               ELSE IF (FILE_FORMAT .EQ. 'EXP') THEN
                  WRITE(IOUNIT,9063) I,GRPVAL(I),(WHRVAL(I,J),
     &                                            J=1+NSPP*(N-1),INGRP)
               END IF
            END DO
            IF (FILE_FORMAT .EQ. 'FIX') THEN
            ...
            ELSE IF (FILE_FORMAT .EQ. 'EXP') THEN
               WRITE(IOUNIT,9065) GRPAVE,(WAVEV(I),I=1+NSPP*(N-1),INGRP)
            END IF
         ELSE
...
C           Print Out The Source Contributions for the Current Page
     ...
     &                                            J=1+NSPP*(N-1),NSPP*N)
            ...
            ELSE IF (FILE_FORMAT .EQ. 'EXP') THEN
              WRITE(IOUNIT,9065) GRPAVE,(WAVEV(I),I=1+NSPP*(N-1),NSPP*N)
            END IF
         END IF
