...
C     The computations are made only for a stable atmosphere
...
C        Determine the reference level for computing a temperature
C        gradient for profiling
